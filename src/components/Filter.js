...
const Filter = ({ filterTimeline }) => {
	
	const showFilters = () => {
		// Build filter params
		const params = {
			locations: [
				'Varanese 2106 Frankfort Ave, Louisville, KY'
			]
		}
		filterTimeline(params)
	}

	return (
		<button className='filter-button' aria-label='Filter' title='Filter' onClick={showFilters}>
